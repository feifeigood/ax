...
type ConversationEvent struct {
	...
	// Opaque metadata produced by the harness for this terminal event.
	HarnessMetadata []byte `protobuf:"bytes,8,opt,name=harness_metadata,json=harnessMetadata,proto3" json:"harness_metadata,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ConversationEvent) GetHarnessMetadata() []byte {
	if x != nil {
		return x.HarnessMetadata
	}
	return nil
}
...
type HarnessEnd struct {
	...
	// Opaque metadata associated with this completed turn.
	HarnessMetadata []byte `protobuf:"bytes,3,opt,name=harness_metadata,json=harnessMetadata,proto3" json:"harness_metadata,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *HarnessEnd) GetHarnessMetadata() []byte {
	if x != nil {
		return x.HarnessMetadata
	}
	return nil
...
type ExecResponse struct {
	...
	// Opaque metadata associated with the terminal event at step.
	HarnessMetadata []byte `protobuf:"bytes,3,opt,name=harness_metadata,json=harnessMetadata,proto3" json:"harness_metadata,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ExecResponse) GetHarnessMetadata() []byte {
	if x != nil {
		return x.HarnessMetadata
	}
	return nil
